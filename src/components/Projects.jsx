...
export default function Projects() {
    return (
        <>
            <h1 className='name-header'> Software Engineering Projects</h1>
            <section className="projects-section">
                ...
                <img src="./portfolio/material-ui-icon.png" alt="Materialize-UI logo" className="tech-logo2" /> Materialize UI
                    ...
                    <div className="button-container">
                        <a href="https://date-night-app-57a5365aa17a.herokuapp.com" className="button">Live App</a>
                        <a href="https://github.com/aydagonzalez15/date-night-app-project-4" className="button github-button">GitHub</a>
                    </div>
                </div>
                ...
                <div className="project-card">
                    ...
                    <div className="button-container">
                        <a href="https://connectionfarmer-8077fbac5cc8.herokuapp.com/" className="button">Live App</a>
                        <a href="https://github.com/aydagonzalez15/connection-farmer/tree/main" className="button github-button">GitHub</a>
                    </div>
                ...
                <div className="project-card">
                    ...
                    <p>
                        ...
                        Integrated the Google Book API, allowing users to easily search for and add books to their library, thereby enriching the user experience with the application.
                    </p>
                    ...
                    <div className="button-container">
                        <a href="https://libros-web-app-e2ea9ebfcbfc.herokuapp.com/books" className="button">Live App</a>
                        <a href="https://github.com/aydagonzalez15/bookshelf-web-app?tab=readme-ov-file" className="button github-button">GitHub</a>
                    </div>
                ...
                <div className="project-card">
                    ...
                    <p>
                        ...
                        Implemented dynamic DOM manipulation and event listeners to create a responsive game resulting in an engaging user experience.
                    </p>
                    ...
                    <div className="button-container">
                        <a href="https://aydagonzalez15.github.io/Spaceman-Game/" className="button">Live App</a>
                        <a href="https://github.com/aydagonzalez15/Spaceman-Game" className="button github-button">GitHub</a>
                    </div>
